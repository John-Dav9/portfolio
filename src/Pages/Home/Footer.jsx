  ...
  return (
    <footer className="footer--container">
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with love by John David</p>
        <p className="footer--content">Dedicated with love to my wife</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <RouterLink to="/privacy-policy" className="text-sm">
                Privacy Policy
              </RouterLink>
            </li>
            <li>
              <RouterLink to="/terms-of-service" className="text-sm">
                Terms of Service
              </RouterLink>
            </li>
            <li>
              <RouterLink to="/cookies-settings" className="text-sm">
                Cookies Settings
              </RouterLink>
            </li>
          </ul>
